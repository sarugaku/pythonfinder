...
# import os
# import sys
# sys.path.insert(0, '/home/hawk/git/pythonfinder/src/pythonfinder')
...
init_file = os.path.join(root, 'src', 'pythonfinder', '__init__.py')
...
htmlhelp_basename = 'pythonfinderdoc'
...
latex_documents = [
    (master_doc, 'pythonfinder.tex', 'pythonfinder Documentation',
...
man_pages = [
    (master_doc, 'pythonfinder', 'PythonFinder Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pythonfinder', 'PythonFinder Documentation',
     author, 'pythonfinder', 'Cross Platform Search Tool for Finding Pythons.',
     'Miscellaneous'),
]
