...
STACKLESS = ["stackless-{0}".format(v) for v in ([
    "dev", "2.7-dev", "2.7.2", "2.7.3", "2.7.4", "2.7.5", "2.7.6", "2.7.7", "2.7.8",
    "2.7.9", "2.7.10", "2.7.11", "2.7.12", "2.7.14", "3.2.2", "3.2.5", "3.3.5", "3.3.7",
    "3.4-dev", "3.4.1", "3.4.2", "3.4.7", "3.5.4"])
]
PYPY = ['pypy3-2.3.1', 'pypy3-2.4.0-src', 'pypy3-2.4.0', 'pypy2-5.6.0', 'pypy2.7-5.10.0', 'pypy2.7-6.0.0', 'pypy-5.3.1', 'pypy3.5-5.10.1', 'pypy3.5-6.0.0-src', 'pypy3.5-6.0.0']
PYSTON = ['pyston-0.5.1', 'pyston-0.6.0', 'pyston-0.6.1']
MINICONDA = ['miniconda-2.2.2', 'miniconda-3.0.0', 'miniconda-3.0.4', 'miniconda-3.0.5', 'miniconda-3.3.0', 'miniconda-3.4.2', 'miniconda3-3.18.3', 'miniconda3-3.19.0', 'miniconda3-4.0.5', 'miniconda3-4.1.11', 'miniconda3-4.3.27', 'miniconda3-4.3.30']
MICROPYTHON = ['micropython-1.9.3', 'micropython-1.9.4']
JYTHON = ['jython-2.5-dev', 'jython-2.5.1', 'jython-2.5.2', 'jython-2.5.3', 'jython-2.5.4-rc1', 'jython-2.7.0', 'jython-2.7.1']
ANACONDA = ['anaconda2-2.4.1', 'anaconda2-2.5.0', 'anaconda2-4.0.0', 'anaconda2-4.1.0', 'anaconda2-4.1.1', 'anaconda2-4.2.0', 'anaconda2-4.3.0', 'anaconda2-4.3.1', 'anaconda2-4.4.0','anaconda3-4.1.1', 'anaconda3-4.2.0', 'anaconda3-4.3.0', 'anaconda3-4.3.1', 'anaconda3-4.4.0', 'anaconda3-5.0.0', 'anaconda3-5.0.1', 'anaconda3-5.1.0', 'anaconda3-5.2.0', 'anaconda3-5.3.0']
IRONPYTHON = ['ironpython-dev', 'ironpython-2.7.4', 'ironpython-2.7.5', 'ironpython-2.7.6.3', 'ironpython-2.7.7']
ACTIVEPYTHON = ['activepython-2.7.14', 'activepython-3.5.4', 'activepython-3.6.0',]
PYTHON = ['2.7.11', '2.7.12', '2.7.13', '2.7.14', '2.7.14rc1', '2.7.15', '3.6.6', '3.6.7', '3.7.0', '3.7-dev', '3.7.1', '3.8-dev']
...
def setup_pythons(tmpdir):
    ...
    with runner.isolated_filesystem(), vistir.contextmanagers.temp_environ():
        ...
        for python in itertools.chain(STACKLESS, PYPY, PYSTON, MINICONDA, MICROPYTHON,
                                      JYTHON, ANACONDA, IRONPYTHON, ACTIVEPYTHON, PYTHON):
